...
const ButonSection = () => {
    ...
    return (
        <div className='flex flex-wrap w-11/12 gap-2 pl-8'>
            <button className='font-fredoka font-black text-white shadow-xl rounded-lg bg-boton p-2'>All</button>
            <Buttons text='Cakes' icon={Cake}/>
            <Buttons text='Cakes Sugar Free' icon={CakeFree}/>
            <Buttons text='Cupcakes' icon={Cupcake}/>
            <Buttons text='Chocolateria' icon={Chocolate}/>
        </div>
    )
}
